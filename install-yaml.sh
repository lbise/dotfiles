#!/usr/bin/env bash
# YAML-driven install script for Leo's dotfiles
set -euo pipefail
...
source "$SCRIPT_DIR/lib/symlinks-yaml.sh"
source "$SCRIPT_DIR/lib/packages-yaml.sh"
source "$SCRIPT_DIR/lib/software.sh"
source "$SCRIPT_DIR/lib/keys.sh"
source "$SCRIPT_DIR/lib/environment.sh"

function print_usage() {
    USAGE="$(basename "$0") [-h|--help] [-p|--profile PROFILE] [-t|--test] -- Install dotfiles using YAML config
...
echo "#########################################################################"
echo "Leo's dotfiles install script (YAML-driven version)"
echo "#########################################################################"
...
echo "#########################################################################"
echo "YAML-driven installation completed"
echo "#########################################################################"
