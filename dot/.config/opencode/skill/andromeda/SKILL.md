...
* Building a lib : build.py -p prj/rcu/lib/dmtx
* Build and run all tests : build.py -p prj/tst/unity_host/dmtx/base -x
* Build and run a single test : build.py -p prj/tst/unity_host/dmtx/base -x --match-test my_test
