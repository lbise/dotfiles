...
PACMAN_PKGS="zsh tmux git unzip swaybg mako hypridle hyprlock man-db man-pages waybar impala fcitx5 fcitx5-configtool fcitx5-gtk brightnessctl jq grim slurp satty"
